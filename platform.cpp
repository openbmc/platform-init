...
void init_nvidia_gb200()
{
    init_nvidia_gb200(false);
}

void init_nvidia_gb200_with_p2020()
{
    init_nvidia_gb200(true);
}
...
constexpr std::array<std::pair<std::string_view, int (*)()>, 1> init_functions{
