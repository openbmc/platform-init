 ...
 * @return An empty result on success, invalid_argument if value is
 * empty, or the write error.
 */
 ...
 * @return An empty result on success, invalid_argument if id is empty,
 * or the write error.
 */
 ...
 * @return An empty result on success, invalid_argument if device is
 * empty, or the write error.
 */
